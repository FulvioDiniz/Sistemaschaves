...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        while(i != 8){
            ...
            System.out.println("8 - Listar Emprestimo nao finalizado");
    ...
    private static void listaEmprestimoNaoFinalizado(){
        for (Emprestimo e : emprestimos) {
            if(e.getPessoaDevolucao() == null){
                System.out.println(e);
            }
        }
    }
